                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="nama_guru" name="nama_guru" value="" class="form-control"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="guru_id">Kode Mapel</label>
                                <input type="text" id="guru_id" name="guru_id" value="" class="form-control"
                                    readonly>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="mapel" name="mapel" value="" class="form-control"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="kkm">KKM</label>
                                <input type="text" onkeypress="return inputAngka(event)" maxlength="2" value="}"
                                    id="kkm" name="kkm" class="form-control" required>
                            </div>
                            <div class="form-group">
