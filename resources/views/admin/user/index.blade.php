        ...
        $(document).ready(function() {
            $('#role').change(function() {
                ...
                if (kel == "Guru") {
                    ...
                    $("#tingkatanKelas").html(
                        `<label for="name">Tingkatan Kelas</label><select id="tingkatan_kelas" type="text"
                                    class="form-control @error('tingkatan_kelas') is-invalid @enderror "
                                    name="tingkatan_kelas" value="{{ old('tingkatan_kelas') }}"
                                    autocomplete="tingkatan_kelas">
                                    <option value="">-- Select {{ __('Tingkatan Kelas') }} --</option>
