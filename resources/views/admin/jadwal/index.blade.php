            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select id="guru_id" name="guru_id" class="form-control @error('guru_id') is-invalid @enderror select2bs4">
                      ...
                      @foreach ($guru as $data)
                          <option value="{{ $data->id }}">{{ $data->kode . ' - ' . $data->nama_guru }}</option>
                      @endforeach
                  </select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type='time' id="jam_mulai" name='jam_mulai' class="form-control @error('jam_mulai') is-invalid @enderror jam_mulai" placeholder="{{ Date('H:i') }}">
                </div>
                <div class="form-group">
